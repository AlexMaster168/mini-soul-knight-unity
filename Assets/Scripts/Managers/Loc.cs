...
public static class Loc
{
    static readonly string[] pairs =
    {
        ...
        "Up/Down select  |  T heroes / skins  |  G boys / girls  |  Enter buy or equip  |  E close", "Вгору/Вниз - вибір  |  T - герої / скіни  |  G - хлопці / дівчата  |  Enter - купити чи одягнути  |  E - закрити",
        "Boys", "Хлопці", "Girls", "Дівчата",
